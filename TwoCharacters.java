...
public class TwoCharacters
{
	...
	{
		System.out.println("Your first character has " + ch.getLives() + " lives. It has " + ch.getNumberOfEyes() + " eyes. And the its color is  " + ch.getColor());
	}
	
	public static void display2(MyCharacter ch)
	{
		System.out.println("Your second character has " + ch.getLives() + " lives. It has " + ch.getNumberOfEyes() + " eyes. And the its color is  " + ch.getColor());
	}
}